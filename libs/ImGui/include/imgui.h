...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderAngle(const char* label, double* v_rad, double v_degrees_min = -360.0, double v_degrees_max = +360.0, const char* format = "%.0f deg", ImGuiSliderFlags flags = 0);
