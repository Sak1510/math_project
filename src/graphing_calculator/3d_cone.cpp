...
physics::Vector compass_arrow(compass_r, compass_theta, rnd::CoordSystem::polar);


void false_3d_cone_ImGuiParam(const char *str_name, bool &menu_on);
void pmain::false_3d_cone(rnd::Graph_Window &GW_Window, const char *str_name, bool &menu_on) {
    ...
    rnd::circle(GW_Window.renderer, compass_p, compass_r, c_white);
